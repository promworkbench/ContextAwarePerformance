...
/**
 * Copied from BoxAndWhiskerRenderer, and modified to not draw outliers and far
 * outs
 * 
 * @author B.F.A. Hompes
 *
...
public class CustomBoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
	...
	private static final long serialVersionUID = 6524884198108323968L;
	...
	/**
	 * A flag that, if <code>true</code>, causes the whiskers to be drawn using
	 * the outline paint for the series. The default value is <code>false</code>
	 ...
	 *
	 * @param percent
	 *            the maximum bar width (a percentage, where 0.10 is ten
	 *            percent).
	 *
	...
	/**
	 * Returns the flag that, if <code>true</code>, causes the whiskers to be
	 * drawn using the series outline paint.
	 *
	 * @return A boolean.
	 *
	 * @since 1.0.14
	...
	/**
	 * Sets the flag that, if <code>true</code>, causes the whiskers to be drawn
	 ...
	 *
	 * @param width
	 *            a value between 0 and 1 indicating how wide the whisker is
	...
	public void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot plot,
		...
		if (!(dataset instanceof BoxAndWhiskerCategoryDataset)) {
			throw new IllegalArgumentException("TestBoxAndWhiskerRenderer.drawItem() : the data should be "
