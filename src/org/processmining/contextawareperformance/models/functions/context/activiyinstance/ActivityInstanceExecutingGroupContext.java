 ...
 *
 */
public class ActivityInstanceExecutingGroupContext extends Context<String> {

	private static final long serialVersionUID = 2076948309981632581L;

	public ActivityInstanceExecutingGroupContext() {
		super(ContextType.ACTIVITYINSTANCEEXECUTINGGROUP);
		VERB = "be executed by";
	}
	...
	public String label(EventCollectionEntity entity, EventCollection collection) {
		...
		String labelStart = startEvent != null
				? oe.extractGroup(startEvent) != null ? oe.extractGroup(startEvent) : "unknown"
				: "unknown";
		String labelComplete = completeEvent != null
				? oe.extractGroup(completeEvent) != null ? oe.extractGroup(completeEvent) : "unknown"
				: "unknown";
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof ActivityInstanceExecutingGroupContext))
			return false;

		ActivityInstanceExecutingGroupContext context = (ActivityInstanceExecutingGroupContext) obj;
